...
const PROOF_ICONS = [Radar, Network, ShieldCheck];
      ...
      <div className="relative z-10 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-3">
          {proofPoints.map((point, i) => {
            const Icon = PROOF_ICONS[i] ?? ShieldCheck;
            return (
              <motion.div
                key={point.title}
