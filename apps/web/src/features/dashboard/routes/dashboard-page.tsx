    ...
    <div className="space-y-6 p-3 sm:p-4 lg:p-6">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
        ...
        <KpiCard
          ...
          delta={
            activeJobs.length
              ? t("dashboard.autoRefreshEnabled")
              : t("dashboard.idle")
          }
          icon={MapPinned}
        />
      ...
      <section className="grid gap-4 xl:grid-cols-[1.15fr_0.85fr]">
        <Card className="overflow-hidden rounded-[1.5rem] border-border bg-card/95">
          <CardHeader>
            ...
            <CardDescription>
              {t("dashboard.discoveryThroughputDescription")}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="overflow-hidden rounded-[1.5rem] border-border bg-card/95">
          <CardHeader>
            ...
            <CardDescription>
              {t("dashboard.leadScoreDistributionDescription")}
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <section className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <Card className="rounded-[1.5rem] border-border bg-card/95">
          <CardHeader>
            ...
            <CardDescription>
              {t("dashboard.priorityLeadQueueDescription")}
            </CardDescription>
          </CardHeader>
                ...
                >
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <Badge tone={bandTone(lead.latest_band)}>
                      {lead.latest_band
                        ? titleCaseLabel(lead.latest_band)
                        : t("dashboard.unscored")}
                    </Badge>
                  </div>
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    {lead.website_domain ? (
                      <Badge tone="accent">{lead.website_domain}</Badge>
                    ) : null}
                  </div>
                </Link>
              ))
        ...
        <div className="space-y-4">
          <Card className="rounded-[1.5rem] border-border bg-card/95">
            <CardHeader>
              ...
              <CardDescription>
                {t("dashboard.regionOperationsDescription")}
              </CardDescription>
            </CardHeader>
          ...
          <Card className="rounded-[1.5rem] border-border bg-card/95">
            <CardHeader>
              ...
              <CardDescription>
                {t("dashboard.aiAuditActivityDescription")}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
