...
test.describe("adaptive hardening matrix", () => {
  test("public routes remain adaptive across desktop/tablet/mobile", async ({
    page,
  }, testInfo) => {
    test.skip(
      testInfo.project.name !== "laptop",
      "Run adaptive matrix once on chromium laptop project.",
    );
    ...
    await expectStableScreenshot(
      page.locator("body"),
      "adaptive-public-mobile-login.png",
    );
  });
  ...
  test.describe("authenticated routes", () => {
    ...
    test("app routes remain adaptive across desktop/tablet/mobile", async ({
      page,
    }, testInfo) => {
      test.skip(
        testInfo.project.name !== "laptop",
      ...
      await expectStableScreenshot(
        page.locator("main"),
        "adaptive-app-desktop-dashboard.png",
      );
      ...
      await expectStableScreenshot(
        page.locator("main"),
        "adaptive-app-mobile-settings.png",
      );
    });
  });
});
